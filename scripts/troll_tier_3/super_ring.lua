...
MainFrame.BackgroundColor3 = Color3.fromRGB(70, 72, 74)
...
Watermark.Text = "Super Ring by NPCraftin"
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    ToggleButton.BackgroundColor3 = ringPartsEnabled and Color3.fromRGB(50, 205, 50) or Color3.fromRGB(238, 0, 0)
    playSound("12221967")
end)
...
local userId = Players:GetUserIdFromNameAsync("NPCraftin")
...
local userId = Players:GetUserIdFromNameAsync("Nodecostopper")
local thumbType = Enum.ThumbnailType.HeadShot
local thumbSize = Enum.ThumbnailSize.Size420x420
local content, isReady = Players:GetUserThumbnailAsync(userId, thumbType, thumbSize)
